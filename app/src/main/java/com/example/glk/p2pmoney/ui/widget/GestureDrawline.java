package com.example.glk.p2pmoney.ui.widget;
...
import com.example.glk.p2pmoney.common.Constants;
import com.example.glk.p2pmoney.ui.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		super(context);
		screenDispaly = UIUtils.getScreenDisplay(context);
		...
		paint.setColor(Color.rgb(245, 142, 33));// 设置默认连接线颜色
	...
	/**
	 * ͨ通过点的位置去集合里面查找这个点事包含在哪个Point里面的
	 * 
	 * @param x
	 * @param y
